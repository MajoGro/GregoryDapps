  ...
  getData = () => {
    ...
    axios({
      ...
      "headers":{
        ...
        "x-rapidapi-key":"f2d163ff5cmshfaf2bff9e53b3bbp15d822jsn61b8d4d1097c",
        "useQueryString":true
      }
    })
    .then((response) => {
    ...
    return (
      <div>
        <nav className="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow text-monospace text-white">
          ...
          {/* TODO: Code goes here... */this.state.loading ? <div id="loader" className="nav-item text-nowrap d-none d-sm-none d-sm-block">Loading...</div> :
